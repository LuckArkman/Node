...
public class Tensor
{
    ...
    public Tensor(double[] data, int[] shape)
    {
        ...
        {
            throw new ArgumentException("O tamanho dos dados não corresponde às dimensões do shape.");
        }
    }
    ...
    public double Infer(int[] indices)
    {
        ...
        for (int i = 0; i < indices.Length; i++)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(indices), "Índice fora dos limites do tensor.");
            }
        }
